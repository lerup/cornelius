...
going to include description

**[01:03]** of several peer reviewed studies and the tools that emerge from those scientific
...
Huberman Lab Podcast was Dr. Wendy Suzuki.

**[02:05]** Dr. Suzuki is a professor of
...
cognitive abilities and improve them over time.

**[03:07]** I'll also provide you important details about that protocol and other protocols. For instance, contrary to popular belief, it is not, I repeat it is not a good idea to do a focused based meditation within the four hours before bedtime. Many people, including some of the
...
the studies that we describe as well as some of the behavioral tools and other tools that we'll cover,

**[04:10]** things like the use of binaural beats, supplements, et cetera. Our goal here again is to provide you the
...
of a given supplement.

**[05:15]** So by using single ingredient supplements, you can really build
...
switching and so on and so on. Fortunately, Thesis understands this

**[06:18]** and has developed custom nootropics that are tailored to your specific goals and your specific needs. They use only the highest
...
they are customized to you. So you can go to Thesis,
...
four different formulas to try in your first month. Again, that's takethesis.com/huberman and use the code Huberman at checkout to get 10% off your first box. Today's episode is also
brought to us by LMNT. LMNT is an electrolyte drink that has all the things you
need and none of what you don't. That means the electrolytes,

**[07:22]** salt, magnesium, and
potassium are in there, but it does not have sugar. Electrolytes are key to cellular function, in particular neuronal
...
milligrams of potassium and 60 milligrams of magnesium. If you'd like to try LMNT, you can go to drinklmnt,
...
brought to us by Eight Sleep. Eight Sleep makes smart mattress covers with heating, cooling, and
sleep tracking capacity.

**[08:26]** The reality is that
...
up of core body temperature. By sleeping on an Eight
...
Airbnbs include Eight Sleep. If you want to try Eight Sleep, you can go to eightsleep.com/huberman and check out their new Pod 3 Cover to save $250 off as a
special Labor Day offer now through September 11th. Eight Sleep currently ships
within the USA, Canada,

**[09:29]** and the United Kingdom. Again, that's
...
the shaft of that arrow, right, the straight line is epinephrine, also called adrenaline.

**[10:30]** And today, I'll refer to adrenaline and
...
metaphorical arrowhead

**[11:37]** that represents focus and concentration is going to be represented or related to the
...
tightly focused arrowhead, well, that's focused on one location. So we have alertness, epinephrine, and then we have the actual direction

**[12:40]** in which our concentration
...
with and buffer stress

**[14:46]** and on and on. Those episodes are all available to you in their long form at hubermanlab.com, you can find them very easily. They are all timestamped so you can navigate to
...
**[15:51]** whereas modulation is the ability of chemicals
...
that's going to allow you to overcome chronic sleep deprivation and allow you to remain focused,

**[16:54]** no pill, no device, no supplement,
...
a fire alarm in this building or if we had a fire in this building, my attention would drift, it would not be on recording this podcast, it would be on something else.

**[17:57]** But would I say that the fire
...
within deep brain centers and can increase focus and concentration

**[19:01]** in part by increasing levels of the neurochemical
...
40 HZ binaural beats on the entire time I'm doing that about of cognitive work.

**[20:04]** I'll also sometimes use
...
various protocols and tools to sleep well and sufficiently long 80% of the nights of your life,

**[21:06]** and you are interested in additional tools that are sound based in order to improve your ability
...
**[22:11]** this front area, sort of the
...
**[23:14]** You might jog for a few minutes or even walk before you would jog and then jog before you would run, right, I would hope you would do that. And if you're doing resistance training, I doubt that you go over and
...
the arrow, it's very broad, it's pointed at a lot of things.

**[24:19]** And over time as we drop into focus, that arrow is narrowing and
...
circuits responsible for focus

**[25:22]** repeatedly over time through
...
circa, the day, circadian,

**[26:29]** is about 24 hour cycle. Well, our brain and body
...
set a timer for 90 minutes. I acknowledge and accept the fact that under most conditions unless I'm really pressed for a deadline and I'm optimally caffeinated, et cetera,

**[27:32]** the first five to 10
...
respect to caloric need.

**[28:35]** So understand that at
...
to deliberately decompress, to let your mental states idle,

**[29:41]** to not be focused on any one thing. That period of idling is essential for your ability to focus, much in the same way that rest between sets
...
form of restoration, even if we have very intense dreams.

**[30:44]** So take that period after each
...
dropping into focus, you're actually going to need more deliberate decompression and defocus and I recommend only doing about two,

**[31:47]** maybe three deep work sessions per day. So not one 90 minute session
...
to rest after that work. I at this stage of my life am pretty good at dropping into

**[32:49]** and maintaining focused
...
**[33:55]** for more than 90 minutes per day." That's not what I'm saying. These are deep focus bouts. These are bouts of work, or I should say mental
...
like mood, immune function,

**[34:59]** hormone function, and on and on. Whenever somebody has asked me, what's the one supplement
...
my stance about nutrition. I fully support and applaud

**[37:07]** those of you that are
...
ways to approach all this,

**[38:11]** whether or not you're a vegan, omnivore, vegetarian, carnivore, et
...
some wiggle around that, occasionally have an early breakfast, I'm not super rigid about it, but I know there are a number of people who are doing longer fasts

**[39:13]** or they're eating in a six hour window. We did an entire episode about fasting, you can again find that
...
that when you ingest food, there's a shift in your nervous system

**[40:15]** towards so-called parasympathetic mode, that is the more relaxed, you've probably heard
...
food and your belly is full, your focus and concentration is reduced.

**[41:19]** But having enough blood glucose and maybe even elevated blood glucose will increase cognitive function. So there are two ends of the spectrum. On one end of the spectrum, blood glucose is relatively
...
fasted and then I'll eat

**[42:22]** and then I do notice after I eat, I actually have a diminished
...
**[43:25]** which is based on the biology of adenosine and caffeine, et cetera, which is to delay your
...
**[44:30]** And as a brief note about ketosis, for those of you that actually managed to transition into ketosis and are maintaining a ketogenic state, that, as I mentioned earlier, can enhance brain function,
...
of artificial sweetener or something like that, but really haven't ingested any significant number of calories

**[45:33]** in the previous four to
...
include a lot of tyrosine, which is a precursor to dopamine,

**[46:36]** and now you know why dopamine
...
**[47:42]** The key is to eat enough that you're nourished for
...
**[48:46]** or panic attacks, and you're not used to ingesting caffeine and you run out and ingest
...
mate brands out there.

**[49:49]** The most cost effective way to consume it would be to use the loose leaf tea and to pour water over that. There's one particular brand that I like, I don't have any affiliation
...
builds up in our brain and body the longer we are awake,

**[51:55]** it's part of the sleepiness
...
**[53:00]** and in fact, that has been studied. There's an excellent study that was carried out not that
...
**[54:04]** It's a paper published in the "Journal of Experimental
...
simulated job interview, an arithmetic task,

**[55:07]** and they're being evaluated
...
for one to five minutes. If you're not used to it,

**[56:10]** you probably want to
...
something in order to spike, to increase their epinephrine

**[57:12]** as a way to consolidate those memories. For the sake of today's discussion, if you are interested in ways to improve
...
you really want to get out, but safe to stay in,

**[58:13]** not so cold that it's going
...
**[59:16]** as a tool for focus and concentration, but if you look at the data on epinephrine and how powerfully it can increase focus, I think you'd be very impressed. I mean it certainly can
...
ways to approach that. If you'd like to know how long the positive effects of epinephrine last toward improving focus and concentration,

**[60:21]** well, if we look to that
...
of the purely behavioral tools that quality peer reviewed science say

**[61:24]** can improve focus and
...
do just nasal breathing for a period of 13 minutes,

**[62:27]** concentrating on that breathing, and concentrating, meaning
...
such a meditation practice to improve concentration and focus is that you are continually refocusing

**[63:30]** back to that specific location and refocusing back on your breath. This is something that again,
...
**[64:33]** of the sort that I described, 13 minute meditation practice every day, you'd want to sit or lie
...
good at naming things, but this sort of meditation practice

**[65:36]** has been shown in the study by the Suzuki
...
focus and stay concentrated. In fact, I invite you to interpret

**[66:39]** every time that you
...
prior to your bedtime. Earlier I mentioned

**[67:41]** that I would talk about
...
progressive deep relaxation, it involves a body scan,

**[68:43]** some long exhale breathing. It is very restorative in the
...
per day every single day, not just on days where I'm sleep deprived. If I happen to be sleep deprived,

**[69:45]** I would extend that NSDR
...
immensely beneficial practice. There's growing amounts of quality science

**[70:49]** pointing to the neurochemical
...
to refocus and focus, whereas during NSDR and yoga nidra, you're actually trying to defocus.

**[71:52]** So you can think of the
...
the array of practices here so you can think about them logically,

**[72:56]** the focus refocus meditation is based on and focused
...
within the Reveri app

**[74:02]** specifically geared towards improving focus and concentration. So again, there's meditation for focus, there's deliberate
...
**[75:06]** I don't think I'm unique in that sense, they have a lot of data
...
neural mechanisms and measured things with a lot of rigor, et cetera, et cetera. These tools are available to you, I highly recommend that you use them. And if you're interested

**[76:08]** in the optimal time of day to do these, we already mentioned that
...
something in a very specific way

**[77:13]** and stay focused on it, to read or to follow
...
straw view of the world or you're looking through a tunnel,

**[78:15]** your focus, your visual focus is actually driving your cognitive focus. Your cognitive focus is
...
meditation refocusing practice that we talked about earlier, that the refocusing is the key component of teaching yourself or your brain, you are your brain, your brain is you,

**[79:17]** but to teach yourself how to focus better. So if you're going to
...
recruiting certain elements of your so-called prefrontal cortex,

**[80:19]** also the frontal eye fields, which are locations not far
...
evaluate other primates

**[81:25]** while not necessarily
...
covert attention and focus

**[82:30]** by looking straight forward for instance, and attending to something
...
you exercise that practice is you are ramping up neural activity

**[83:38]** within the neural circuits that create focus and concentration. Then, I would stop
...
increase your overall ability to focus and concentrate,

**[84:39]** and then applying that to whatever it is that you're trying to learn or perform. Next, I'd like to talk about compounds that can improve concentration and focus, and these are most often
...
**[85:46]** And while there's some debate about whether or not it can
...
for other sources of EPAs, you can find those out there certainly.

**[86:48]** Some people even use prescription EPAs to get the dosage really high. Dr. Ronda Patrick talked about
...
bulk of scientific studies

**[87:52]** have examined the role of
...
**[88:55]** to generate focus and concentration. So much like sleep, much
...
transiently within the brain, there's a greater opportunity

**[89:57]** for neuroplasticity to take place. And the reason there's
...
milligrams is enough for me,

**[91:00]** and I tend to be quite
...
offset increases in TMAO

**[92:06]** that are associated either with Alpha-GPC or increases due to other things, so ingestion of particular food compounds actually can increase TMAO, is to offset that by taking
...
milligram capsule of garlic anytime I take Alpha-GPC,

**[93:09]** which again for me is
...
derived from food sources, I invite you to look up those various food sources on the web, simply go to a web browser and put in

**[94:10]** foods that contain a lot of L-tyrosine and you'll get a rich array
...
a very inefficient way to go about life.

**[95:14]** In fact, I make it a
...
to go into those states without any help at all. And this is what I find particularly attractive about supplements. It's not so much that they put you into the ideal state for that work and then you accomplish that work

**[96:18]** and then you always rely
...
increase dopamine transmission in the brain, so increasing dopamine,

**[97:22]** and all of which generally
...
**[98:28]** all these things are stimulants. So you take a kid who has attention deficit
...
students say the statistics are using prescription drugs when they are not in fact

**[99:30]** prescribed those prescription drugs. So basically what I'm saying is there are a lot of people using drugs designed for ADHD and narcolepsy because those drugs will effectively increase
...
how to engage better. But as a general backdrop to all of this,

**[100:35]** I always say and I'll
...
people cannot access the brain states required

**[101:39]** to shift themselves purely
...
the importance of that, that the behavioral tools,

**[102:41]** and to some extent the supplementation combined with behavioral tools really allow you to train
...
like feeling too jittery,

**[103:45]** that's not really my goal, it's the goal to be alert, but not so alert that I really
...
in the early part of the day, certainly before the noon hour,

**[104:48]** so that I am in no way
...
they've changed their format. It was terrific before, it provided links to relevant studies, it talked about specific compounds, it talked about the magnitude of effect, it talked about the human effect matrix,

**[105:51]** it really focused on human studies with links to those studies and on and on. The new revamped version of
...
has been to provide you

**[106:54]** an understanding of the
...
**[107:57]** to pick and choose which of these protocols you
...
to focus so much better

**[109:01]** when you do decide to return to a about of focus, concentrated
...
subscribe to the podcast on Spotify and Apple. That's also a zero cost way to support us. And on both Spotify and Apple, you can leave us up to a five star review. If you have questions for us
...
**[110:03]** the Huberman Lab Podcast is now partnered with
...
following us on social media, we are hubermanlab on Twitter, and we are also hubermanlab on Instagram. Both places, I talk about science
...
and essential protocols from the Huberman Lab Podcast episodes. You can access it totally free of charge by going to hubermanlab.com, go to the menu and click on newsletter, provide your email.

**[111:04]** We do not share your email with anybody and you'll receive our monthly newsletter. There are also examples of
...
and especially the tools for enhancing concentration and focus, and last but certainly not least, thank you for your interest in science. [upbeat music]
